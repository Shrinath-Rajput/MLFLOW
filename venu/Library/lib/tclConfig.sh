...
# installed.
TCL_PREFIX='D:/e drive/Only_Project/BentoMl/venu\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/e drive/Only_Project/BentoMl/venu\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/e drive/Only_Project/BentoMl/venu\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/e drive/Only_Project/BentoMl/venu\Library\include'
...
TCL_PACKAGE_PATH='D:/e drive/Only_Project/BentoMl/venu\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/e drive/Only_Project/BentoMl/venu\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/e drive/Only_Project/BentoMl/venu\Library\lib\tclstub86.lib'
